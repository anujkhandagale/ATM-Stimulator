...
public class SignupThree extends JFrame implements ActionListener{
	...
	SignupThree(String formno) {
		...
		r4 = new JRadioButton("Depsite AccountReccuring ");
		r4.setFont(new Font("Railway", Font.BOLD, 16));
		r4.setBackground(Color.WHITE);
		r4.setBounds(350, 220, 250, 20);
		add(r4);
		
		ButtonGroup groupaccouunt = new ButtonGroup();
		groupaccouunt.add(r1);
		groupaccouunt.add(r2);
		groupaccouunt.add(r3);
		groupaccouunt.add(r4);	
		...
		cancle.setFont(new Font("Railway", Font.BOLD, 14));
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource() == submit) {
			...
			if (r1.isSelected()) {
				...
				accountType = "Depsite AccountReccuring";
			}
